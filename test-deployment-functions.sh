...
test_validation_functions() {
    ...
    local valid_urls=("https://example.com" "http://test.azure.com/api/func" "https://subdomain.domain.com/path?query=value")
    local invalid_urls=("ftp://example.com" "example.com" "not-a-url")
